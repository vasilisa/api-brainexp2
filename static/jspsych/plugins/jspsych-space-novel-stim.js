			...
			var display_stimuli = function(stage){
				...
				if (stage==-1) { // timeout	at first level
					if (state == 0) {
						...
						$('#jspsych-space-novel-bottom-stim-left').css('background-image', 'url(../static/img/'+state_name+'_stim_'+stims[0]+'_deact.png)');
						$('#jspsych-space-novel-bottom-stim-right').css('background-image', 'url(../static/img/'+state_name+'_stim_'+stims[1]+'_deact.png)');
					} else {
						$('#jspsych-space-novel-bottom-stim-left').html('<br><br>X');
						$('#jspsych-space-novel-bottom-stim-left').css('background-image', 'url(../static/img/'+state_name+'_stim_deact.png)');
					}
				}
				...
				if (stage==1) { // choice stage
					...
					$('.jspsych-display-element').css('background-image', 'url("../static/img/'+state_name+'_planet.png")');				
					
					if (state>0) {
						display_element.append($('<div>', {
							style: 'background-image: url(../static/img/earth_stim_'+choice1+'_deact.png)',
					...
					if (state == 0) {
						display_element.append($('<div>', {
							style: 'background-image: url(../static/img/'+state_name+'_stim_'+stims[0]+'.png)',
						...
						display_element.append($('<div>', {
							style: 'background-image: url(../static/img/'+state_name+'_stim_'+stims[1]+'.png)',
							id: 'jspsych-space-novel-bottom-stim-right',
						}));
					} else {
						display_element.append($('<div>', {
							style: 'background-image: url(../static/img/'+state_name+'_stim.png)',
							id: 'jspsych-space-novel-bottom-stim-left',
						}));
				...
				if (stage==3) { // reward
					if (points>0) {
						$('#jspsych-space-novel-top-stim').css('background-image', 'url(../static/img/treasure_'+points+'.png)');
					}
					if (points<0) {
						$('#jspsych-space-novel-bottom-stim-left').css('background-image', 'url(../static/img/'+state_name+'_stim_sad.png)');
						$('#jspsych-space-novel-top-stim').css('background-image', 'url(../static/img/antimatter_'+(-1*points)+'.png)');
					}
					if (points==0) {
						$('#jspsych-space-novel-top-stim').css('background-image', 'url(../static/img/noreward.png)');
					}
				}
				...
				if (stage==4) { // 
					...
					if (points > 0) {
						picture = '../static/img/treasure_'+points+'.png';
					}
					if (points < 0) {
						picture = '../static/img/antimatter_'+Math.abs(points)+'.png';
					}
					if (points == 0) {
						picture = '../static/img/noreward.png';
					}
					
					$('.jspsych-display-element').css('background-image', 'url("../static/img/earth_planet.png")');
					display_element.append($('<div>', {
